...
<!-- Begin Page Content -->
<div class="container">
    <h5 style="margin: 30px 0 20px 0"><i class="fas fa-users"></i> <strong>Lista de Alumnos</strong></h5>
    <div class="row">

        <div class="col-lg-8 mb-2">
            <a href="<?php echo base_url(); ?>Alumnos/ListarH" class="btn btn-primary mb-2"><i class="fas fa-arrow-alt-circle-left"></i> Regresar</a>

        <footer class="footer"">
            <div class="footer__block block no-margin-bottom" style="border: none; box-shadow: 10px 0px 0px 0px rgba(0, 0, 0, 0.40); background: white;">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url(); ?>Usuarios/cambiar" method="post" id="cambiarContra">
                            ...
                            <div class="form-group">
                                ...
                                <input id="confirmar" class="form-control" type="password" name="confirmar" placeholder="Confirmar Contraseña Nueva">
                            </div>
                            <button class="btn btn-primary" type="submit" id="cambiar">Cambiar</button>
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url(); ?>Usuarios/cambiarpic" method="post" enctype="multipart/form-data">
                            ...
                            <div class="custom-file">
                              ...
                              <label><br><strong>Nota:</strong> Se recomienda poner una imagen cuadrada para que se pueda apreciar.</label>
                            </div>
                            </div>

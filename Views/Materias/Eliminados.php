...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-2">
            <a href="<?php echo base_url(); ?>Materias/Listar" class="btn btn-primary mb-2"><i class="fas fa-arrow-alt-circle-left"></i> Regresar</a>
        </div>
        <div class="col-lg-4">
                ...
                <?php if($_SESSION['rol'] >= $us['rol']){ ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="<?php echo base_url() ?>Materias/eliminarper?id=<?php echo $us['id']; ?>" method="post" class="d-inline elimper">

...
<!-- Begin Page Content -->
<div class="container">
    <h5 style="margin: 30px 0 20px 0"><i class="fas fa-users"></i> <strong>Lista de Usuarios</strong></h5>
    <div class="row">
        <div class="col-lg-8 mb-2">
            ...
            <a href="<?php echo base_url(); ?>/Usuarios/eliminadosH" class="btn btn-dark"><i class="fas fa-users-slash"></i> Inactivos</a>
        </div>
        <div class="col-lg-4">
        ...
        <tbody>
            ...
            <?php if($_SESSION['rol'] >= $us['rol']){ ?>
                <tr>
                    ...
                    <td>
                        <a title="Editar" href="<?php echo base_url() ?>Usuarios/editarH?id=<?php echo $us['id']; ?>" class="btn btn-primary mb-2"><i class="fas fa-edit"></i></a>

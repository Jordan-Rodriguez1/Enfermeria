...
<html lang="es">
  ...
  <head>
    ...
    <title>Enfermería UCOL | Recuperar </title>
    ...
    <div style="background-image: url(../Assets/img/fondo.png); background-repeat: no-repeat; background-size: cover; min-height: 100vh; background-position: center">
      <div class="container">
        <form action="" id="rec" >
          ...
          <br>
          <p>Ponte en contacto con un usuario de tu rango o superior y pidele que restablezca tu contraseña.</p><br>
          <a href="loginprof">Regresar</a><br><br>  
        </form>
      </div>
    </div>
  </body>

...
<div class="container">
  <form action="<?php echo base_url(); ?>Usuarios/login"class="user" method="POST" autocomplete="off">
    <p><img src="../Assets/img/logo2.png"></p>
    <p>Bienvenido Administrador</p><br>
    <input type="number"  name="usuario" placeholder="No. Trabajador" id="usuario"  required><br>
    ...
    <!--<a href="recuperar">¿Olvidate tu contraseña?</a><br><br>-->
    <a href="../">Soy Alumno</a>
  </form>     

...
<div class="container">
  <form action="<?php echo base_url(); ?>Alumnos/login"class="user" method="POST" autocomplete="off">
    <p><img src="Assets/img/logo2.png"></p>
    <p>Bienvenido Alumno</p><br>
    <input type="number"  name="usuario" placeholder="No. Cuenta" id="usuario"  required><br>
    ...
    <!--<a href="recuperar">¿Olvidaste tu contraseña?</a><br><br>-->
    <a href="Login/loginprof">Soy Administrativo</a>
  </form>     
